...
public class BookTicketPage extends GeneralPage {
    ...
    public String getDepartStation() {
        WebElement departStationElement = Constant.WEBDRIVER.findElement(departStationField);
        return departStationElement.getText();
    }

    public String getArriveStation() {
        WebElement arriveStationElement = Constant.WEBDRIVER.findElement(arriveStationField);
        return arriveStationElement.getText();
    }

    public String getSeatType() {
        WebElement seatTypeElement = Constant.WEBDRIVER.findElement(seatTypeField);
        return seatTypeElement.getText();
    }

    public String getAmount() {
        WebElement amountElement = Constant.WEBDRIVER.findElement(amountField);
    ...
    public void selectRandomDepartDate() {
        WebElement dropdown = Constant.WEBDRIVER.findElement(selectDepartDate);
    ...
    private void selectOptionInDropdown(By dropdownLocator, String option) {
        WebElement dropdown = Constant.WEBDRIVER.findElement(dropdownLocator);
        scrollToElement(dropdown);
        Select select = new Select(dropdown);
    ...
    public void clickBookTicketButton() {
        WebElement button = Constant.WEBDRIVER.findElement(btnBookTicket);
